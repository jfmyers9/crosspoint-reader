...
class GfxRenderer {
 ...
 public:
  ...
  bool drawBitmap1Bit(const Bitmap& bitmap, int x, int y, int maxWidth, int maxHeight, uint8_t* outputRow,
                      size_t outputCapacity, uint8_t* rawRow, size_t rawCapacity) const;
